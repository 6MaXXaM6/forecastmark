...
Попробовать бота: [@forecastmark_bot](https://t.me/forecastmark_bot) (хостился на cloud.ru((, в РФ, пока не успел купить себе VPS где то заграницей и всё там настроить)
